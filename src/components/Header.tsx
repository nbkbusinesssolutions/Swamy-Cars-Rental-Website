...
export default function Header() {
  ...
  const handleScroll = useCallback(() => {
    ...
    if (scrollY > 100) {
      const direction = scrollY > (window as unknown as { lastScrollY?: number }).lastScrollY ? 'down' : 'up';
          ...
          >
            <nav className="px-4 py-4 space-y-1">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block px-4 py-3 mt-4 text-center bg-[#25D366] text-white font-semibold rounded-xl"
              >
                Chat on WhatsApp
              </a>
            </nav>
